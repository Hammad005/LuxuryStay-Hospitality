...
const CancelBookingAlert = ({open, setOpen, selectBooking, setSelectBooking}) => {
    const {cancelBooking, bookingLoading} = bookingStore();
    
    const handleCancelBooking = async () => {
        await cancelBooking(selectBooking?._id);
