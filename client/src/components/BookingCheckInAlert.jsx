...
const BookingCheckInAlert = ({openCheckIn, setOpenCheckIn, selectBooking, setSelectBooking}) => {
    const {createBookingCheckIn, checkInLoading, resetSuccess} = checkInStore();
    const handleCheckIn = async () => {
        const response = await createBookingCheckIn(selectBooking);
        if (response.success) {
...
export default BookingCheckInAlert
