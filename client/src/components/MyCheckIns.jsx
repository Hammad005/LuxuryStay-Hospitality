...
const MyCheckIns = () => {
  ...
  const [selectCheckIn, setSelectCheckIn] = useState(null);
  ...
  return (
    <>
      ...
      <Link to="/my-CheckOuts" className="text-sm flex items-center gap-1 text-primary hover:text-white border-b border-white w-fit">
      ...
      <div className="flex flex-col items-center">
        <h1 className="font-semibold md:text-3xl text-2xl text-shadow-md text-shadow-black font-serif flex items-center gap-2 uppercase">
          <BadgeCheck className="size-8 text-primary" /> My CheckIns
        </h1>
        <p className="text-base text-primary/80 mt-2 text-center max-w-xl">
          Here you can view your confirmed check-ins.
        </p>
      </div>
                    ...
                    <TableRow>
                      ...
                      <TableCell className={"text-right"}>
                        <Button
                          variant={"secondary"}
                          onClick={() => {
                            navigateTo(`/checkOut/${checkIn._id}`);
                          }}
                        >
                          Check Out
                        </Button>
