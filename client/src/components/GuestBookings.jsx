...
const GuestBookings = () => {
  const { userBookings } = bookingStore();
    ...
    <>
      ...
      <div className="bg-accent/70 p-6 rounded-md border border-primary flex flex-col items-center">
        <h1 className="font-semibold md:text-3xl text-2xl text-shadow-md text-shadow-black font-serif flex items-center gap-2 uppercase">
          <BookCheck className="size-8 text-primary" /> My Bookings
        </h1>
        <p className="text-base text-primary/80 mt-2 text-center max-w-xl">
          Here you can review and manage all your bookings with ease.
        </p>

        {userBookings.filter((booking) => booking.bookingStatus === "Confirmed")
          .length > 0 ? (
          userBookings
